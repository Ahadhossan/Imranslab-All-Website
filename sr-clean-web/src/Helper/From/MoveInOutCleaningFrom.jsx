...
function MoveInOutCleaningFrom() {
  ...
  return (
    <div className="bg-[#001011] shadow-md p-6 rounded-lg">
      {success && (
        <p
          className={`text-center text-sm font-medium ${success.includes("successfully")
              ? "text-green-500"
              : "text-red-500"
            }`}
        >
      ...
      <form className="space-y-4" onSubmit={onSubmit}>
        <h3 className="text-xl font-semibold text-[#00D47E] mb-2">
          Book Your Move In Out Cleaning
        </h3>
...
export default MoveInOutCleaningFrom;
