        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2 mb-6">
              <img
<<<<<<< HEAD
                src="https://i.ibb.co/YFtgGkjv/logo.png" // Ensure your image is in /public/assets/
=======
                src="https://i.imghippo.com/files/jNmq8245oDU.png" // Ensure your image is in /public/assets/
>>>>>>> b015c053d9cdc2d2114ccb58abe336afc6cb8c9a
            ...
            <p className="text-sm">
              QuickClean delivers fast, reliable, and affordable cleaning
              services for homes and offices across Canada.
            </p>
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
            {Object.entries(footerLinks).map(([title, links]) => (
              <div key={title}>
                <h3 className="text-lg font-bold mb-4 text-[#00D47E]">
                  {title}
                </h3>
                <ul className="space-y-2 text-sm">
                  {links.map((link, i) => (
                    <li key={i}>
                      <a
                        href={link.href}
                        className="hover:text-[#00D47E] transition"
                      >
                        {link.name}
                      </a>
                    </li>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm">
          <p>
            ...
            <a href="#" className="text-[#00D47E] font-bold">
              @imranslab Team
            </a>{" "}
            <img
