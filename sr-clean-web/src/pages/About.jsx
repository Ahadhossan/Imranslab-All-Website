          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2 flex flex-col items-center">
              ...
              <div className="w-full max-w-md">
                <img src="https://i.ibb.co/ccsWDqYK/blog-1.jpg" alt="Blog 1" className='rounded-lg shadow-md w-full object-cover' />
              </div>
            </div>
          </div>
        </div>
    ...
    padding: 0 0 0 1.5rem;"
                >
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> Locally
                    owned.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> Supplies
                    provided.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> Equipment
                    provided.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> Fully
                    insured.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> No term
                    contracts.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" />
                    Neighborly Done Right Promise<sup>®</sup>.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.ibb.co/9HTWRBZq/download.png" alt="" /> Trusted Locally
                    owned.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.imghippo.com/files/oFC6404J.png" alt="" border="0"/> Supplies
                    provided.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.imghippo.com/files/oFC6404J.png" alt="" border="0"/> Equipment
                    provided.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.imghippo.com/files/oFC6404J.png" alt="" border="0"/> Fully
                    insured.
                  </a>
                  <a className="flex gap-4">
                    <img src="https://i.imghippo.com/files/oFC6404J.png" alt="" border="0"/> No term
                    contracts.
                  </a>
                </ul>
              </div>
