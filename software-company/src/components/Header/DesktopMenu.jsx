...
export default function DesktopMenu({ menu }) {
 ...
 const gridClass = `grid-cols-3 sm:grid-cols-${gridCols}`;
  ...
  return (
    ...
    >
      <a
        className="flex items-center gap-1 text-sm lg:text-base text-black font-semibold hover:bg-white/5 px-3 py-2 rounded-xl cursor-pointer"
      ...
      {hasSubMenu && (
        <motion.div
          className="absolute mt-2 backdrop-blur-xl bg-white/95 text-black rounded-xl shadow-xl w-full max-w-[100vw] md:min-w-[600px] p-5 z-40 origin-top border border-white/30"
          initial="exit"
