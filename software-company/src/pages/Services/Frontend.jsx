...
import FrontendFrom from "../../Helper/From/Services/FrontendFrom";
...
const Frontend = () => {
      ...
      <div className="w-full hero-bg py-24 px-4 md:px-12">
        <div className="max-w-8xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            "
            >
              We focus on usability and aesthetics to create powerful first impressions that captivate your users and put your business ahead of the competition.
            </p>
            <a
              href="/contact"
  ...
  <p className="text-sm sm:text-base font-extrabold text-[#151517] text-center sm:text-left leading-relaxed">
    Our frontend development services encompass everything from responsive design solutions to holistic UI and UX design for your project. With over a decade of experience, we have delivered frontend development services to a number of industries from finance and healthcare to education and travel.
  </p>
      ...
      <section className="max-w-9xl mx-auto px-6 py-10 sm:px-8 lg:px-10 bg-white">
        <header className="mb-6">
          ...
          <p className="text-[#151517] max-w-full sm:max-w-2xl">
            Our frontend development process follows a clear set of tools, techniques, and guidelines. This ensures that every project is efficient, consistent, and user-focused. Here’s how we approach it.:
          </p>
        </header>
