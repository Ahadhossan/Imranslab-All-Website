...
import WebAppFrom from "../../Helper/From/Services/WebAppFrom";
import { faqs, practices, services } from "../../Data/Services/webapp";
  ...
  return (
    <>
      ...
      <div className="w-full hero-bg py-24 px-4 md:px-12">
        <div className="max-w-8xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            "
            >
              Your one-stop shop for stellar web applications, built with the latest technologies to create the value that you and your users are looking for.
            </p>
            <a
              href="/contact"
      ...
      >
        ...
        >
          With an in-depth knowledge of business challenges, technologies, market trends, and regulations, we make sure you don’t have to go anywhere else for your web application development needs. Our web application development team creates high-quality, user-friendly websites and web applications that meet the unique needs of your business, whether it’s a startup or a conglomerate.
        </p>
      ...
      <section className="max-w-9xl mx-auto px-6 py-10 sm:px-8 lg:px-10 bg-white">
        <header className="mb-6">
          ...
          >
            <b>Best</b> Practices in Web App Development
          </h2>
        </header>
